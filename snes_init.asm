...
;             First macro that is called at the start of a program
;             SECTION were it is called is "MainCode" (bank 0)
;---------------|---------|------------|-------------------------------------
.macro InitSNES
...
InitializeSNES: PHK                   ;set Data Bank = Program Bank
  ...
  Loop03:                             ;regs $2123-$2133
                ...
                ;**** Reset all palette colors to zero ********                
  ...
  Loop08:       STA       $2104       ;set X = 240
                ...
                LDX       #$0020
  Loop09:       STZ       $2104       ;set size bit=0, x MSB = 0
                DEX
                BNE       Loop09
